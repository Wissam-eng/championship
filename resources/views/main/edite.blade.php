...
@section('content')
    ...
    <div class="container" style="width: 50%;">
        ...
        <!-- form controls -->
        <form class="space-y-5" method="POST" action="{{ route('main.update', $card) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="address" value="{{ $card->address }}" placeholder="Some Text..."
                    class="form-input" required />
            </div>
